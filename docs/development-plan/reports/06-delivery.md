...
B 于 21:43 UTC 经独立画面评审仍失败：暂停黑图、地形硬边、守卫死亡悬浮、跳跃缺口可读性，以及未覆盖的交互/音频证据。21:50 UTC 通过正式 `resumeProject` 在原预算继续，之前使用 6 回合/3 修复，记录 `.noobi-private/stage-06/b/resumed-b.json`；没有增加预算。A 21:53 UTC 仍在画面样板，累计 9 回合/5 修复/1 重连，达到原上限后必须停止，不自动扩额。
