...
describe('loadCliConfig', () => {
  ...
  it('should apply desktop runtime request timeout and retry safeguards', async () => {
    vi.stubEnv('MODEL_REQUEST_TIMEOUT', '180000');
    ...
    const config = await loadCliConfig(
      {
        model: {
          generationConfig: { timeout: 600000, maxRetries: 3 },
        },
      } as Settings,
      [],
      new ExtensionEnablementManager(
